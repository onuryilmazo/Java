...
public class Snake extends JPanel{
    ...
    public Snake(main.Main window){
        ...
        Rectangle last = this.body.get(0); //last listenin başı yani yılanın başı
        ...
        /*
        body.add(new Rectangle((last_2.getPosx() - rec_width, last_2.getPosy())))
        Bu satır, body adlı ArrayList'e bir başka Rectangle nesnesi ekler. Bu dikdörtgen, last_2 adlı değişkenin getPosx() ve getPosy() yöntemlerini kullanarak oluşturulur. Yeni eklenen dikdörtgen, last_2 değişkeninin solundan (getPosx() - rec_width) mevcut konumuna ve aynı yüksekliğe sahip olacak şekilde konumlandırılır.
        Sonuç olarak, bu kodlar yılanın vücut parçalarını güncellemek için kullanılır. Yılanın son vücut parçasının solundan bir vücut parçası eklenir ve bu yeni vücut parçası, bir öncekinin solundan bir diğer vücut parçası daha ekler. Bu şekilde yılanın vücut parçaları oluşturulur ve hareket ettikçe vücut parçaları da güncellenir.
        * */
    ...
    public void addPart(){
        ...
        switch (this.direction) {
            ...
            case "down" -> this.body.add(new Rectangle(last.getPosx(), last.getPosy()-rec_height));
        }
    }
